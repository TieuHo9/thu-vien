...
@Component({
  selector: 'jhi-de-xuat-thanh-toan-update',
  templateUrl: './de-xuat-thanh-toan-update.component.html',
})
export class DeXuatThanhToanUpdateComponent implements OnInit {
  isSaving = false;
  ...
  payments: string[] = ['Chua thanh toan', 'Da thanh toan'];
  selectedPayment = ['Chua thanh toan'];
  ...
  protected updateForm(deXuatThanhToan: IDeXuatThanhToan): void {
    this.editForm.patchValue({
      ...
      thanhToan: deXuatThanhToan.thanhToan,
    });
  ...
  protected createFromForm(): IDeXuatThanhToan {
    return {
      ...
      thanhToan: this.editForm.get(['thanhToan'])!.value,
    };
  }
}
